# Cerinta se afla in fisierul .txt din folder
import csv
import pandas as pd
...
def logica_meniu(*args):
    ...
    while intreaba in '1' or '2' or '3' or '4' or '5' or '6' or '7':
        if intreaba == '1':
            sortare = sorted(dictionar_date, key=lambda x: x[
                0])  # aici imi sorteaza lista de categorii de la inceput.Cred ca ar trebui cea cu taskuri..
